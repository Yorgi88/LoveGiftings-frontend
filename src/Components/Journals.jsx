...
const Contents = () => {
  ...
  useEffect(()=>{
    dispatch(fetchProducts('journals'));
  }, [dispatch]);

  // const journalProd = products.filter((product)=>product.category.slug==='journals');
   ...
   const journals =productsByCategory['journals']|| [];
  ...
  return (
    <section className="carousel-section" id="journals">
      <div className="text-center mb-4">
        <h2>Journals</h2>
        <p>Take a look at these cool Journals</p>
      </div>
      <Carousel
